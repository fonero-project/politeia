...
import (
	...
	v1 "github.com/fonero-project/politeia/politeiawww/api/www/v1"
	wwwclient "github.com/fonero-project/politeia/politeiawww/cmd/politeiawwwcli/client"
	"github.com/fonero-project/politeia/politeiawww/cmd/politeiawwwcli/config"
...
type Cmds struct {
	...
	SendFaucetTx        SendFaucetTxCmd        `command:"sendfaucettx" description:"         send a FNO transaction using the Fonero testnet faucet"`
