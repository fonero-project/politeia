...
import (
	...
	"github.com/fonero-project/politeia/politeiad/api/v1"
...
type config struct {
	...
	PaywallAmount            uint64 `long:"paywallamount" description:"Amount of FNO (in atoms) required for a user to register or submit a proposal."`
